    ...
    <div className="max-w-6xl mx-auto p-4 md:p-6 space-y-5">
      <div>
        ...
        <h1 className="text-xl font-semibold text-slate-800 flex items-center gap-2">
          <Inbox className="w-5 h-5" style={{ color: '#1A77A3' }} /> Verifikasi &amp; Persetujuan
        </h1>
        <p className="text-sm text-slate-500 mt-0.5">Transaksi yang menunggu diproses oleh Anda — transaksi milik sendiri tidak ditampilkan (segregation of duties)</p>
      </div>
