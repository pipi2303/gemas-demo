  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-6 space-y-6">
      ...
      <FinancePageHeader
        ...
        systemBadge="Standar Akuntansi Sinodal"
        metaBadge="Double-Entry Engine"
        primaryAction={
          onNavigate
            ? {
        ...
        infoStrip={[
          {
            label: 'Sub-Modul',
            value: '9 Modul Terintegrasi',
            color: 'emerald',
          },
          {
            label: 'Akuntansi',
            value: 'PSAK 45 / ISAK 35',
            color: 'sky',
          },
          {
            label: 'Database',
            value: status?.mode === 'postgresql' ? 'PostgreSQL' : 'Active Storage',
            color: 'teal',
          },
          {
            label: 'Kepatuhan',
